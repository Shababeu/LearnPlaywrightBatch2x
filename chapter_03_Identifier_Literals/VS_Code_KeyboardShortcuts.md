...
| `Ctrl + Shift + Alt + P` | Open Process Explorer |
...
| `Ctrl + Shift + A` | Toggle block comment (alternate) |
...
| `Ctrl + K Ctrl + Left Arrow` / `Right Arrow` | Focus previous / next editor group |
| `Ctrl + Shift + PgUp` / `PgDn` | Move editor left / right |
| `Ctrl + K Left Arrow` / `Right Arrow` | Move active editor group |
...
You can view and customize all shortcuts by pressing:
```
Ctrl + K Ctrl + S
```
